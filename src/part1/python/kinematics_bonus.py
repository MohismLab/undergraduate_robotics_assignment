...
class RobotDrawer(object):
    ...
    def __init__(self, ax, pose, radius=0.05, label=None, color="g"):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dt",
        type=positive_floats,
        action="store",
        default=(0.05,),
        help="Integration step.",
    )
    parser.add_argument(
        "--animate", action="store_true", default=False, help="Whether to animate."
    )
